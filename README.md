...
🔗 - [GitHub](https://github.com/jgthms/bulma) ⭐ 50,058 | 🐛 527 | 🌐 CSS | 📅 2026-03-01 - Source code, issues, and releases\
🔗 - [Releases](https://github.com/jgthms/bulma/releases) ⭐ 50,058 | 🐛 527 | 🌐 CSS | 📅 2026-03-01 - Changelog and version history\
...
💻 - [Bulma Snippets for Sublime Text 3](https://github.com/OthmaneBlial/Bulma-Snippets-Sublime-Text-Plugin) ⭐ 13 | 🐛 1 | 📅 2019-10-21 - A set of Bulma Snippets for Sublime Text\
💻 - [Bulma Autocomplete for Sublime Text 3](https://github.com/leuchte/bulma-autocomplete) ⭐ 11 | 🐛 0 | 🌐 Python | 📅 2020-06-14 - Sublime Text autocomplete plugin for the Bulma CSS Framework\
💻 - [Bulma Autocomplete 2.0 for Atom](https://github.com/lowlevelm/Bulma-autocomplete-2) ⭐ 3 | 🐛 2 | 🌐 JavaScript | 📅 2021-09-06 - An Atom module to improve your Bulma workflow

### Open-Source Projects

:octocat: - [FileGator](https://github.com/filegator/filegator) ⭐ 3,051 | 🐛 215 | 🌐 PHP | 📅 2026-08-13 - Powerful Multi-User File Manager\
...
:octocat: - [Python Discord Site](https://github.com/python-discord/site) ⭐ 653 | 🐛 53 | 🌐 Python | 📅 2026-08-10 - Django and Bulma web application powering pythondiscord.com

### Templates

🖼️ - [awesome-bulma-templates](https://github.com/aldi/awesome-bulma-templates/) ⭐ 516 | 🐛 0 | 📅 2026-06-21 - Free Real World Templates built with Bulma\
...
🖼️ - [bulma-coming-soon-template](https://github.com/aldi/bulma-coming-soon-template) ⭐ 6 | 🐛 0 | 🌐 HTML | 📅 2026-02-20 - Free Coming Soon Template built with Bulma\
🖼️ - [bulma-event-participation-template](https://github.com/aldi//bulma-event-participation-template) ⭐ 5 | 🐛 0 | 🌐 HTML | 📅 2026-03-04 - Free Event Participation Template built with Bulma\
...
🖼️ - [bulma-templates](https://github.com/BulmaTemplates/bulma-templates) ⭐ 3,325 | 🐛 3 | 🌐 HTML | 📅 2026-03-04 - Free Flexbox Templates built with Bulma\
...
🖼️ - [jekyll-bulma](https://github.com/erayaydin/jekyll-bulma) ⭐ 27 | 🐛 4 | 🌐 CSS | 📅 2017-12-12 - Bulma Jekyll Template based on Bulma\
...
* [blazorise](https://github.com/Megabit/Blazorise) ⭐ 3,533 | 🐛 140 | 🌐 C# | 📅 2026-08-14 - Components for Blazor with support for Bulma
...
* [oruga](https://github.com/oruga-ui/oruga) ⭐ 1,166 | 🐛 21 | 🌐 Vue | 📅 2026-08-07 - UI components library without CSS framework dependency
...
* [oruga-ui/theme-bulma](https://github.com/oruga-ui/theme-bulma) ⭐ 109 | 🐛 2 | 🌐 SCSS | 📅 2026-08-04 - Bulma theme for Oruga components
...
* [Bestax](https://github.com/allxsmith/bestax) ⭐ 11 | 🐛 41 | 🌐 TypeScript | 📅 2026-08-14 - A full-featured React library for Bulma, built for AI-powered development
* [buefy](https://buefy.org/) - Lightweight UI components for Vue.js based on Bulma

## Extensions

* [BulmaJS](https://github.com/VizuaaLOG/BulmaJS) ⭐ 343 | 🐛 24 | 🌐 JavaScript | 📅 2026-07-25 - JavaScript helpers for interactive Bulma components
...
* [bulma-list](https://github.com/bluefantail/bulma-list) ⭐ 48 | 🐛 3 | 🌐 SCSS | 📅 2025-01-17 - A simple list component extension for Bulma
* [bulma-block-list](https://github.com/chrisrhymes/bulma-block-list) ⭐ 42 | 🐛 0 | 🌐 SCSS | 📅 2024-12-28 - A simple scss package extending Bulma with block style list elements
* [bulma-spacing](https://github.com/kaangokdemir/bulma-spacing) ⭐ 19 | 🐛 5 | 🌐 SCSS | 📅 2023-12-15 - Missing spacing classes for Bulma ecosystem
* [bulma-tagsfield](https://github.com/crabvk/bulma-tagsfield) ⭐ 12 | 🐛 2 | 🌐 JavaScript | 📅 2022-05-09 - Multi-line tags input control
* [@cityssm/bulma-js](https://github.com/cityssm/bulma-js) ⭐ 4 | 🐛 7 | 🌐 TypeScript | 📅 2026-02-26 - JavaScript helpers for Bulma websites
* [bulma-tagsinput](https://github.com/bulma-extensions/bulma-tagsinput) ⭐ 1 | 🐛 0 | 📅 2025-04-25 - Modernize an add interaction on input of tags type
* [bulma-timeline](https://github.com/bulma-extensions/bulma-timeline) ⭐ 0 | 🐛 0 | 🌐 SCSS | 📅 2025-04-25 - Display a vertical timeline, in different colors, sizes, and states
* [bulma-steps](https://github.com/bulma-extensions/bulma-steps) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2025-04-25 - Display steps for a process with different colors, sizes, and states
* [bulma-switch](https://github.com/bulma-extensions/bulma-switch) ⭐ 0 | 🐛 0 | 🌐 SCSS | 📅 2025-04-25 - Display the classic checkbox as a switch button with different colors, sizes, and states
* [bulma-pageloader](https://github.com/bulma-extensions/bulma-pageloader) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2025-04-25 - Display a page-loader to inform users that content is loading, in different colors
* [bulma-checkradio](https://github.com/bulma-extensions/bulma-checkradio) ⭐ 0 | 🐛 0 | 🌐 Sass | 📅 2025-04-25 - Make classic checkbox and radio sexier with different colors, sizes, and states
* [bulma-pricingtable](https://github.com/bulma-extensions/bulma-pricingtable) ⭐ 0 | 🐛 0 | 🌐 Sass | 📅 2025-04-25 - Display pricing tables with different colors and styles
* [bulma-slider](https://github.com/bulma-extensions/bulma-slider) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2025-04-25 - Display a classic slider with different colors, sizes, and states
* [bulma-ribbon](https://github.com/bulma-extensions/bulma-ribbon) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2025-04-25 - Bulma's extension to show a ribbon on boxes
* [bulma-quickview](https://github.com/bulma-extensions/bulma-quickview) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2025-04-25 - Display a quick view of data without leaving the current page
* [bulma-carousel](https://github.com/bulma-extensions/bulma-carousel) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2025-04-25 - A simple carousel/slider extension for Bulma
* [bulma-iconpicker](https://github.com/bulma-extensions/bulma-iconpicker) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2025-04-25 - Display an input as an Icon Picker to ease the user icon selection
* [bulma-divider](https://github.com/bulma-extensions/bulma-divider) ⭐ 0 | 🐛 0 | 📅 2025-04-25 - Display a vertical or horizontal divider to segment your design
* [bulma-badge](https://github.com/bulma-extensions/bulma-badge) ⭐ 0 | 🐛 0 | 📅 2025-04-25 - Display a badge element in front of Bulma's element in different colors
* [bulma-tooltip](https://github.com/bulma-extensions/bulma-tooltip) ⭐ 0 | 🐛 0 | 📅 2025-04-25 - Display a tooltip attached to any kind of element with different positioning
* [bulma-social](https://aldi.github.io/bulma-social) - 🤳 Social Sign-In Buttons based on Bulma and Font Awesome
* [bulma-accordion](https://www.jsdelivr.com/package/npm/bulma-accordion) - A simple accordion extension for Bulma
